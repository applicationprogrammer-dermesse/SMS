<%@ Page Title="Discounted Sales" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DiscountedSales.aspx.cs" Inherits="SMS.DiscountedSales" %>
    ...
    <div id="container">
        ...
        <div class="row" style="margin-bottom: 15px;">
            <div class="col-sm-12 text-center">
                <asp:Label ID="Label2" runat="server" Text="Discounted Sales"></asp:Label>
            </div>
        </div>
        ...
        <div class="row" style="margin-bottom: 10px;">
            <div class="col-sm-12">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                      <button id="btnGenerate" onserverclick="btnGenerate_Click" type="submit" onclick="showDiv();" runat="server" validationgroup="grpIss" class="btn btn-primary">GENERATE&nbsp;&nbsp;&nbsp;<i class="fa fa-toggle-right"></i></button>
                        &nbsp;&nbsp;&nbsp;
                ...
                <div class="col-sm-3">
                           <div id='myHiddenDiv' style="text-align:center "> 
                                   <img src='' id='myAnimatedImage' alt="" height="50px" /> 
                         </div>
                 </div>
            </div>
        </div>
                      ...
                      <asp:GridView ID="gvPerSku" runat="server" Width="98%" ShowFooter="true" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false" >
                           <FooterStyle BackColor="PaleGoldenrod" Font-Bold="true" />
                             <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Sales Date" DataField="SalesDate"  ReadOnly="True" DataFormatString="{0:MM/dd/yyyy}" ItemStyle-Width="8%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
                                 ...
                                 <asp:BoundField HeaderText="Gender" DataField="Gender"  ReadOnly="True" ItemStyle-Width="5%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
                                   ...
                                   <asp:TemplateField HeaderText="Date Of Birth">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lbDateOfBirth" runat="server"
                                                    Text='<%#  Convert.ToString(Eval("DateOfBirth", "{0:MM/dd/yyyy}")).Equals("01/01/1900")?"":Eval("DateOfBirth", "{0:MM/dd/yyyy}")%>'></asp:Label>
                                            </ItemTemplate>
                                  </asp:TemplateField>

                                       <asp:BoundField HeaderText="Age" DataField="AgeIntYears"  ReadOnly="True" ItemStyle-Width="5%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
