<%@ Page Title="Report - All Type of Payment" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportAllPaymentType.aspx.cs" Inherits="SMS.ReportAllPaymentType" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="container-fluid" style="width: 98%">
                <div class="row" style="margin-bottom: 25px;">
                    <div class="row">
                        ...
                        <div class="col-sm-3 text-center" style="background-color: #f2f2f2; color: maroon; border-radius: 15px;">
                            <h4>All Type of Payment Transaction</h4>
                        </div>
                        <div class="col-md-4 text-center">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <asp:GridView ID="gvAllTypePayment" Width="99%" runat="server" AutoGenerateColumns="false" class="table table-striped table-bordered table-hover">
                            <Columns>
