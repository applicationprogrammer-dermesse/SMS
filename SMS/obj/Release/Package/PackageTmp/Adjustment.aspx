<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Adjustment.aspx.cs" Inherits="SMS.Adjustment" %>
        ...
        <div class="row" style="margin-bottom: 12px;">
         ...
         <div class="row">
                            <div class="col-sm-12" style="margin-bottom: 15px;">
                                ...
                                <div class="col-sm-10" >
                                    <div class="input-group">
                                     <asp:TextBox ID="txtReason" runat="server"  class="form-control" Style="width: 385px;" MaxLength="249" onkeydown="return (event.keyCode!=13);" autocomplete="off" AutoCompleteType="Disabled"></asp:TextBox>
