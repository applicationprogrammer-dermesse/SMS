<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewTransactionReturn.aspx.cs" Inherits="SMS.ViewTransactionReturn" %>
        ...
        <div class="row" style="margin-bottom: 12px;">
            <div class="row">
                ...
                <div class="col-sm-3 text-center" style="background-color: #f2f2f2; color: maroon; border-radius: 15px;">
                    <h4>Transaction Return Detail</h4>
                </div>
                <div class="col-md-4 text-center">
                </div>
            </div>
        ...
        <div class="row" style="margin-bottom: 8px;">
            <div class="col-sm-12">
                <div class="col-sm-2 text-right">
                    <a href="ReportSalesReturn.aspx" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-arrow-left"></i>&nbsp;&nbsp;Back to previous page</a>
                </div>
