<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DailySalesDetailed.aspx.cs" Inherits="SMS.DailySalesDetailed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="container-fluid"  style="width:98%">
         ...
         <br />
                  <div class="row" >
                    <div class="col-sm-12">
                        <asp:GridView ID="gvSalesDetailed" Width="99%"  runat="server" AutoGenerateColumns="false" class="table table-striped table-bordered table-hover" DataKeyNames="ReceiptNo" OnRowCommand="gvSalesDetailed_RowCommand" OnRowDataBound="gvSalesDetailed_RowDataBound" >
                             <Columns>
                       ...
                       <asp:TemplateField HeaderText="Digital<br /> Payment" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="7%" ItemStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblDigitalPaymentAMT" runat="server" Text='<%# Eval("DigitalPayment AMT","{0:n2}") %>'></asp:Label>
                                   ...
                                   <asp:BoundField HeaderText="Date/Time Encoded" DataField="TransactionDate"  ReadOnly="True"  ItemStyle-Width="5%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
