<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportGiftCode.aspx.cs" Inherits="SMS.ReportGiftCode" %>
            ...
            <div class="container-fluid" style="width: 98%">
                ...
                <div class="row" style="margin-bottom: 15px;">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <asp:DropDownList ID="ddBranch" runat="server" class="form-control" Style="width: 195px;"></asp:DropDownList>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <asp:GridView ID="gvGiftCode" Width="99%" runat="server" AutoGenerateColumns="false" class="table table-striped table-bordered table-hover">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Item Description" DataField="vDESCRIPTION" ReadOnly="True" ItemStyle-Width="15%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                                ...
                                <asp:TemplateField HeaderText="Gross Amount">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotalGrossAmt" runat="server"
                                            Text='<%#  Eval("GrossAmt","{0:n2}")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:BoundField HeaderText="Disc Description" DataField="DiscDesc" ReadOnly="True" ItemStyle-Width="10%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>

                                <asp:BoundField HeaderText="Gift Code" DataField="GiftCode" ReadOnly="True" ItemStyle-Width="5%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                                ...
                                <asp:TemplateField HeaderText="Discount">
                                    ...
                                    <ItemStyle HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotalDiscAmt" runat="server"
                                            Text='<%#  Eval("DiscAmt","{0:n2}")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Net Amount">
                                    ...
                                    <ItemStyle HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotalNetAmt" runat="server"
                                            Text='<%#  Eval("NetAmt","{0:n2}")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
