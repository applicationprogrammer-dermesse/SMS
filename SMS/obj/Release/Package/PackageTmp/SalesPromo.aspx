<%@ Page Title="Sales - Promo" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SalesPromo.aspx.cs" Inherits="SMS.SalesPromo" %>
    ...
    <div id="container">
        ...
        <div class="row" style="margin-bottom: 15px;">
            <div class="col-sm-12 text-center">
                <asp:Label ID="Label2" runat="server" Text="Sales Promo"></asp:Label>
            </div>
        </div>
