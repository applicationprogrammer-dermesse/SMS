<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewTransaction.aspx.cs" Inherits="SMS.ViewTransaction" %>
        ...
        <div class="row" style="margin-bottom: 8px;">
            <div class="col-sm-12">
                <div class="col-sm-2 text-right">
                    <a href="SalesForTheDay.aspx" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-arrow-left"></i>&nbsp;&nbsp;Back to previous page</a>
                </div>
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-sm-12">
                ...
                <div class="col-sm-2 text-left">
                    <asp:Label ID="lblIsReturn" Font-Bold="true" runat="server" Text="" CssClass="form-control label-warning"></asp:Label>
                </div>
            </div>
        </div>
            ...
            <asp:GridView ID="gvPaymentDetail" runat="server" Width="99%" Font-Size="Medium" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Bank Name" DataField="BankName" ReadOnly="True" ItemStyle-Width="15%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                     ...
                     <asp:BoundField HeaderText="Reference Number" DataField="ReferenceNumber" ReadOnly="True" ItemStyle-Width="10%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                    </asp:BoundField>
