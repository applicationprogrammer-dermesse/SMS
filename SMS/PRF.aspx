<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PRF.aspx.cs" Inherits="SMS.PRF" %>
     ...
     <div class="container-fluid"  style="width:98%">
                    ...
                    <div class="col-sm-12">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <asp:TextBox ID="txtPRFNo" runat="server" class="form-control" ReadOnly="true" Style="width: 175px; margin-bottom: 5px;"  onkeydown="return (event.keyCode!=13);" autocomplete="off" AutoCompleteType="Disabled"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                            ControlToValidate="txtPRFNo"  Display="Dynamic" ValidationGroup="grpPRF" ForeColor="Red"
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="ReqDate" runat="server" 
                                            ControlToValidate="txtDateReceived"  Display="Dynamic" ValidationGroup="grpPRF" ForeColor="Red"
                                            ErrorMessage="Required"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="REVdate" runat="server" ControlToValidate="txtDateReceived"
                                            ValidationExpression="^([1-9]|0[1-9]|1[0-2])[- / .]([1-9]|0[1-9]|1[0-9]|2[0-9]|3[0-1])[- / .](1[9][0-9][0-9]|2[0][0-9][0-9])$"
                                            ForeColor="Red"
                                            ErrorMessage="Invalid date format"
                                            ValidationGroup="grpPRF"></asp:RegularExpressionValidator>
                                     </div>
                                </div>
                            </div>
                </div>
        ...
        <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        ...
                        <asp:RequiredFieldValidator ID="ReqAvail" runat="server"
                            ControlToValidate="txtAvailable" Display="Dynamic" ValidationGroup="grpPRF" ForeColor="Red"
                            ...
                            <div class="col-sm-12" style="margin-bottom: 5px;">
                                ...
                                <div class="col-sm-10" >
                                    ...
                                    <asp:RequiredFieldValidator ID="ReqQty" runat="server" 
                                            ControlToValidate="txtQty"  Display="Dynamic" ValidationGroup="grpPRF" ForeColor="Red"
                                            ErrorMessage="Required"></asp:RequiredFieldValidator>
                                        <asp:CompareValidator ID="cvQty" runat="server"
                                            ErrorMessage="Qty s/b less than or equal to available balance!" ValidationGroup="grpPRF" Display="Dynamic"
         ...
         <div class="row">
                            <div class="col-sm-12" style="margin-bottom: 5px;">
                                ...
                                <div class="col-sm-10" >
                                    <div class="input-group">
                                     <asp:TextBox ID="txtBatchNo" runat="server" class="form-control" Style="width: 195px;" onkeydown="return (event.keyCode!=13);" autocomplete="off" AutoCompleteType="Disabled"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                            ControlToValidate="txtBatchNo"  Display="Dynamic" ValidationGroup="grpPRF" ForeColor="Red"
         ...
         <div class="row">
                            <div class="col-sm-12" style="margin-bottom: 5px;">
                                ...
                                <div class="col-sm-10" >
                                    <div class="input-group">
                                     <asp:TextBox ID="txtExpirationDate" runat="server"  class="form-control dateTxtYear" Style="width: 105px;" onkeydown="return (event.keyCode!=13);" autocomplete="off" AutoCompleteType="Disabled"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                            ControlToValidate="txtExpirationDate"  Display="Dynamic" ValidationGroup="grpPRF" ForeColor="Red"
         ...
         <div class="row">
                            <div class="col-sm-12" style="margin-bottom: 5px;">
                                ...
                                <div class="col-sm-10" >
                                    <div class="input-group">
                                     <asp:TextBox ID="txtReason" runat="server" MaxLength="348"  class="form-control" Style="width: 485px;" onkeydown="return (event.keyCode!=13);" autocomplete="off" AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator101" runat="server" 
                                            ControlToValidate="txtReason"  Display="Dynamic" ValidationGroup="grpPRF" ForeColor="Red"
                                            ErrorMessage="Required"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
         ...
         <div class="row">
                            <div class="col-sm-12" style="margin-bottom: 5px;">
                                ...
                                <div class="col-sm-10" >
                                    <div class="input-group">
                                        <asp:DropDownList ID="ddBranch" runat="server" CssClass="form-control"></asp:DropDownList>
        ...
        <div class="row" style="margin-bottom: 15px;">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-10">
                                                <button id="btnSave" onserverclick="btnSave_Click" type="submit" runat="server"  class="btn btn-primary" validationgroup="grpPRF">SAVE&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-save"></span></button>
                                                ...
                                                <%--<button id="btnPrint"  type="submit" runat="server" class="btn btn-danger" visible="false"  validationgroup="grpPRF">P R I N T&nbsp;&nbsp;&nbsp;<i class="fa fa-file-excel-o"></i></button>--%>
                            ...
                            <div class="col-sm-12" style="margin-left:5px;">
                                <asp:GridView ID="gvUnposted" runat="server" Width="99%" Font-Size="Medium" DataKeyNames="ID" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false"  OnRowCancelingEdit="gvUnposted_RowCancelingEdit" OnRowDeleting="gvUnposted_RowDeleting" OnRowEditing="gvUnposted_RowEditing" OnRowUpdating="gvUnposted_RowUpdating" >
                                    <Columns>
                                      ...
                                      <asp:BoundField HeaderText="PRF No." DataField="PRFno"  ReadOnly="True" ItemStyle-Width="125px" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                   ...
                                   <asp:BoundField HeaderText="Transfer To Branch" DataField="BrName"  ReadOnly="True"  ItemStyle-Width="395px" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
