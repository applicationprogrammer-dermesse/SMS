<%@ Page Title="Customer Report" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientReport.aspx.cs" Inherits="SMS.ClientReport" %>
    ...
    <div id="container">
        ...
        <div class="row" style="margin-bottom: 15px;">
            <div class="col-sm-12 text-center">
                <asp:Label ID="Label2" runat="server" Text="Sales Per SKU/Customer"></asp:Label>
            </div>
        </div>
                      ...
                      <asp:GridView ID="gvPerSku" runat="server" Width="98%" ShowFooter="true" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false" >
                           <FooterStyle BackColor="PaleGoldenrod" Font-Bold="true" />
                             <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Category" DataField="vCATEGORY"  ReadOnly="True" ItemStyle-Width="15%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
                                 ...
                                 <asp:BoundField HeaderText="Region/Province" DataField="RegionName"  ReadOnly="True" ItemStyle-Width="10%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
        ...
        function ShowWarningMsg() {
            $(function () {
                $("#messageWarning").dialog({
                    title: "Sales Detailed per Branch/per Client",
                    width: '335px',
                    buttons: {
                        Close: function () {
                            $(this).dialog('close');
