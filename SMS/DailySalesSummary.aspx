<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DailySalesSummary.aspx.cs" Inherits="SMS.DailySalesSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="width: 98%">
        ...
        <div class="row">
            <div class="col-sm-12">
                <asp:GridView ID="gvSalesSummary" Width="99%" ShowFooter="true" runat="server" AutoGenerateColumns="false" class="table table-striped table-bordered table-hover">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Product<br />Gross Amt" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="7%" ItemStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblProductGrossAmt" runat="server" Text='<%# Eval("Product - Gross Amt","{0:n2}") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Product<br />Discount Amt" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="7%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="lblProductDiscountAmt" runat="server" Text='<%# Eval("Product - DiscountAmt","{0:n2}") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <%--here--%>
                <%--        <asp:TemplateField HeaderText="Product<br />Net Amt" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="7%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="lblProductNetAmt" runat="server" Text='<%# Eval("Product - NetAmt","{0:n2}") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        ...
                        <asp:TemplateField HeaderText="Service<br />Gross Amt" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="9%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="lblServiceGrossAmt" runat="server" Text='<%# Eval("Service - Gross Amt","{0:n2}") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Service<br />Discount Amt" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="7%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="lblServiceDiscountAmt" runat="server" Text='<%# Eval("Service - DiscountAmt","{0:n2}") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <%--<asp:TemplateField HeaderText="Service<br />Net Amt" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="7%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="lblServiceNetAmt" runat="server" Text='<%# Eval("Service - NetAmt","{0:n2}") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        ...
                        <asp:TemplateField HeaderText="Net Sales" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="7%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:Label ID="lblNetSales" runat="server" Text='<%# Eval("Net Sales","{0:n2}") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Bank <br />FundTransfer" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="7%" ItemStyle-HorizontalAlign="Center">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
