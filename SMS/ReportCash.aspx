<%@ Page Title="Report-Cash" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportCash.aspx.cs" Inherits="SMS.ReportCash" %>
                ...
                <div class="row" style="margin-bottom: 25px;">
                    <div class="row">
                        ...
                        <div class="col-sm-3 text-center" style="background-color: #f2f2f2; color: maroon; border-radius: 15px;">
                            <h4>Cash Payment Transaction</h4>
                        </div>
                        <div class="col-md-4 text-center">
                        </div>
                    </div>
