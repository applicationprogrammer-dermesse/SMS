...
namespace SMS
{
    public partial class SalesPromo : System.Web.UI.Page
    {
       ...
       // public string CurrmonthName;
        ...
        private void loadBranch()
        {
            using (SqlConnection conN = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["MyConn"].ConnectionString))
            {
                ...
                using (SqlCommand cmD = new SqlCommand(stR, conN))
                {
                    ...
                    ddBranch.Items.Insert(1, new ListItem("All Branches", "1"));
                    ddBranch.SelectedIndex = 0;
                }
            }
        }
            ...
            using (SqlConnection conN = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["MyConn"].ConnectionString))
            {
                ...
                using (SqlCommand cmD = new SqlCommand(stRtoGen, conN))
                {
                    ...
                    if (gvPerSku.Rows.Count > 0)
                    {
                        ...
                        gvPerSku.FooterRow.Cells[8].Text = "Total";
                        ...
                        gvPerSku.FooterRow.Cells[9].Text = total6.ToString("N2");

                        decimal total8 = dT.AsEnumerable().Sum(row => row.Field<decimal>("DiscAmt"));
                        gvPerSku.FooterRow.Cells[11].HorizontalAlign = HorizontalAlign.Right;
                        gvPerSku.FooterRow.Cells[11].Text = total8.ToString("N2");
                        ...
                        gvPerSku.FooterRow.Cells[12].Text = total9.ToString("N2");
                    }
                    else
                    {
        ...
        protected void gvPerSku_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                e.Row.Cells[7].CssClass = forcedCss;
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string localPath = Server.MapPath("~/exlTMP/rptSalesPromo.xlsx");
                string newPath = Server.MapPath("~/exlDUMP/rptSalesPromo.xlsx");
                newFileName = Server.MapPath("~/exlDUMP/SalesPromo.xlsx");
                ...
                if (fi.Exists)
                {
                    ...
                    worksheet.Cell("A3").Value = "Sales - Promo" + ddType.SelectedItem.Text;
                    ...
                    for (int r = 0; r < gvPerSku.Rows.Count; r++)
                    {
                        ...
                        worksheet.Cell(r + 5, 5).Value = Server.HtmlDecode(gvPerSku.Rows[r].Cells[3].Text.TrimEnd());
                        ...
                        worksheet.Cell(r + 5, 9).Value = ((Label)gvPerSku.Rows[r].FindControl("lblQty")).Text;
                        worksheet.Cell(r + 5, 10).Value = ((Label)gvPerSku.Rows[r].FindControl("lblGrossAmt")).Text;
                        worksheet.Cell(r + 5, 11).Value = Server.HtmlDecode(gvPerSku.Rows[r].Cells[10].Text);
                        worksheet.Cell(r + 5, 12).Value = ((Label)gvPerSku.Rows[r].FindControl("lblDiscountsAmt")).Text;
                        worksheet.Cell(r + 5, 13).Value = ((Label)gvPerSku.Rows[r].FindControl("lblNetAmt")).Text;
