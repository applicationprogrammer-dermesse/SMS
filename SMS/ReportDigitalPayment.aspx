<%@ Page Title="Report-Digital Payment" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportDigitalPayment.aspx.cs" Inherits="SMS.ReportDigitalPayment" %>
            ...
            <div class="container-fluid" style="width: 98%">
                <div class="row" style="margin-bottom: 25px;">
                    <div class="row">
                        ...
                        <div class="col-sm-3 text-center" style="background-color: #f2f2f2; color: maroon; border-radius: 15px;">
                            <h4>Digital Payment Transaction</h4>
                        </div>
                        <div class="col-md-4 text-center">
                        </div>
                    </div>
                ...
                <div class="row" style="margin-bottom: 15px;">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <asp:DropDownList ID="ddPartners" runat="server" class="form-control" Style="width: 195px;" oninvalid="this.setCustomValidity('Please select item')" oninput="setCustomValidity('')"></asp:DropDownList>
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <asp:GridView ID="gvDigitalPayment" Width="99%" runat="server" AutoGenerateColumns="false" class="table table-striped table-bordered table-hover">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Partner" DataField="BankName" ReadOnly="True" ItemStyle-Width="10%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                                ...
                                <asp:BoundField HeaderText="Reference No." DataField="ReferenceNumber" ReadOnly="True" ItemStyle-Width="15%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
