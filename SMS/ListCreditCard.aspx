<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListCreditCard.aspx.cs" Inherits="SMS.ListCreditCard" %>
            ...
            <div class="container-fluid" style="width: 98%">
                ...
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <asp:RadioButton ID="rbAll" runat="server" Checked="true" GroupName="grpRB" Text="&nbsp;&nbsp;&nbsp;ALL" OnCheckedChanged="rbAll_CheckedChanged" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:RadioButton ID="rbCC" runat="server" GroupName="grpRB" Text="&nbsp;&nbsp;&nbsp;Credit Cards" OnCheckedChanged="rbCC_CheckedChanged" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:RadioButton ID="rbPaymaya" runat="server" GroupName="grpRB" Text="&nbsp;&nbsp;&nbsp;Paymaya" OnCheckedChanged="rbPaymaya_CheckedChanged" />
                            </div>
                        </div>
                ...
                <div class="row" style="margin-bottom: 10px;">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-9">
                            <asp:DropDownList ID="ddOption" runat="server" CssClass="form-control" Width="175px" AutoPostBack="true" OnSelectedIndexChanged="ddOption_SelectedIndexChanged">
                                <asp:ListItem Value="10" Text="ALL"></asp:ListItem>
                                <asp:ListItem Value="11" Text="Receivables"></asp:ListItem>
                                <asp:ListItem Value="12" Text="Paid"></asp:ListItem>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <asp:GridView ID="gvCC" Width="99%" runat="server" AutoGenerateColumns="false" class="table table-striped table-bordered table-hover">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Batch No" DataField="BatchNumber" ReadOnly="True" ItemStyle-Width="5%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>

                                <asp:BoundField HeaderText="Approval No." DataField="ReferenceNumber" ReadOnly="True" ItemStyle-Width="5%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                            ...
                            <asp:BoundField DataField="CC4Digit" HeaderText="CC No. <br /> (Last 4digit)" HtmlEncode="false" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center" />
                         <asp:BoundField DataField="CCName" HeaderText="Name on CC" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center" />


                                <asp:BoundField HeaderText="Control No" DataField="ControlNo" ReadOnly="True" ItemStyle-Width="5%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
