<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RecordComplimentary.aspx.cs" Inherits="SMS.RecordComplimentary" %>
     ...
     <div class="container-fluid"  style="width:98%">
        <div class="row" style="margin-bottom: 12px;">
            <div class="row">
                ...
                <div class="col-sm-6 text-center" style="background-color:#f2f2f2; color:maroon; border-radius: 15px;">
                    <h4>Complimentary with Consumable Amount</h4>
                </div>
                <div class="col-md-3 text-center">
         ...
         <div class="row">
                           <div class="col-sm-12" style="margin-bottom: 5px;">
                                ...
                                <div class="col-sm-10" >
                                    <div class="input-group">
                                        <asp:DropDownList ID="ddPrimaryCustomer" runat="server" class="chosen-select" Style="width: 495px;" oninvalid="this.setCustomValidity('Please select')" oninput="setCustomValidity('')" AutoPostBack="True" OnSelectedIndexChanged="ddPrimaryCustomer_SelectedIndexChanged"  ></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" InitialValue="0" 
                                            ControlToValidate="ddPrimaryCustomer"  Display="Dynamic" ValidationGroup="grpComplimentary" ForeColor="Red"
                                            ErrorMessage="Required"></asp:RequiredFieldValidator>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" InitialValue="0" 
                                            ControlToValidate="ddPrimaryCustomer"  Display="Dynamic" ValidationGroup="grpView" ForeColor="Red"
                                            ErrorMessage="Required"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                             </div>
      ...
      <div class="row" style="margin-bottom:5px;">
            <div class="col-sm-12">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        <asp:TextBox ID="txtAmountLimit" runat="server" class="form-control" ReadOnly="true" Style="width: 125px; text-align:right;" onkeydown="return (event.keyCode!=13);" autocomplete="off" AutoCompleteType="Disabled"></asp:TextBox>
                    </div>
                </div>
        ...
        <div class="row" style="margin-bottom:5px;">
            <div class="col-sm-12">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        <asp:TextBox ID="txtTotalAmount" runat="server" class="form-control" ReadOnly="true" Style="width: 125px; text-align:right;" onkeydown="return (event.keyCode!=13);" autocomplete="off" AutoCompleteType="Disabled"></asp:TextBox>
                        &nbsp;&nbsp;
                        <button id="btnView"  type="submit" onserverclick="btnView_Click" runat="server" class="btn btn-default"  validationgroup="grpView">View Transaction History</button>
         ...
         <div class="row">
                            <div class="col-sm-12" style="margin-bottom: 5px;">
                                ...
                                <div class="col-sm-10" >
                                    <div class="input-group">
                                     <asp:TextBox ID="txtCustomerName" runat="server" MaxLength="348"  class="form-control" Style="width: 485px;" onkeydown="return (event.keyCode!=13);" autocomplete="off" AutoCompleteType="Disabled"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator101" runat="server" 
                                            ControlToValidate="txtCustomerName"  Display="Dynamic" ValidationGroup="grpComplimentary" ForeColor="Red"
                                            ErrorMessage="Required"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-10" >
                                    <div class="input-group">
                                        <asp:DropDownList ID="ddITemFG" runat="server" class="chosen-select" Style="width: 695px;" oninvalid="this.setCustomValidity('Please select item')" oninput="setCustomValidity('')" AutoPostBack="True" OnSelectedIndexChanged="ddITemFG_SelectedIndexChanged" ></asp:DropDownList>
                                            ...
                                            ControlToValidate="ddITemFG" Display="Dynamic" ValidationGroup="grpComplimentary" ForeColor="Red"
                                ...
                                <asp:GridView ID="gvUnposted" runat="server" Width="99%" Font-Size="Medium" DataKeyNames="ID" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false"  OnRowCancelingEdit="gvUnposted_RowCancelingEdit" OnRowDeleting="gvUnposted_RowDeleting" OnRowEditing="gvUnposted_RowEditing" OnRowUpdating="gvUnposted_RowUpdating" >
                                  ...
                                  <%--   <asp:TemplateField HeaderText="Batch No.">
                                     ...
                                     <asp:TemplateField HeaderText="Total">
                                            ...
                                            <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblCompliAmount" runat="server" 
                                                    Text='<%#  Eval("CompliAmount","{0:N2}")%>'></asp:Label>
                                            </ItemTemplate>
