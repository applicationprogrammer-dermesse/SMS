<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewTransactionPosted.aspx.cs" Inherits="SMS.ViewTransactionPosted" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid" style="width: 98%">
        ...
        <div class="row" style="margin-bottom: 8px;">
            <div class="col-sm-12">
                <div class="col-sm-2 text-right">
                    <a href="DailySalesDetailed.aspx" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-arrow-left"></i>&nbsp;&nbsp;Back to previous page</a>
                </div>
                
           <%--20220321--%>
                     <div class="col-sm-10 text-right"  style="display:none;">
                            <button id="btnPrintPreview"  onserverclick="btnPrintPreview_Click" type="submit" runat="server"  class="btn btn-default" >RE-PRINT RECEIPT&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-print"></span></button>
                </div>
        ...
        <div class="row" style="margin-bottom: 10px;">
            <div class="col-sm-12">
                ...
                <div class="col-sm-1 text-left">
                    <asp:Label ID="lblTransactionStatus" Font-Bold="true" runat="server" Text="" CssClass="form-control label-success"></asp:Label>
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-sm-12">
                <div class="col-sm-2 text-right">
                    <%--<asp:Label ID="lblDep" Font-Bold="true" runat="server" Text="Transaction Type :"></asp:Label>--%>
                    Transaction Type :
                </div>
                <div class="col-sm-4 text-left">
                    <asp:Label ID="lblDeposit" Font-Bold="true" runat="server" Text=""></asp:Label>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Disc Amount">
                        ...
                        <ItemTemplate>
                          ...
                          <asp:BoundField HeaderText="Session" DataField="NoSession" HtmlEncode="false" ReadOnly="True">
                        <HeaderStyle Width="15px" HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>

                    <asp:BoundField HeaderText="Performed By" DataField="PerformedBy" HtmlEncode="false"  ReadOnly="True">
        ...
        <div class="col-sm-12">
            <asp:GridView ID="gvPaymentDetail" runat="server" Width="99%" Font-Size="Medium" class="table table-striped table-bordered table-hover" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Bank Name" DataField="BankName" ReadOnly="True" ItemStyle-Width="15%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                    </asp:BoundField>


                     <asp:BoundField HeaderText="Batch Number" DataField="BatchNumber" ReadOnly="True" ItemStyle-Width="10%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                    </asp:BoundField>

                     <asp:BoundField HeaderText="Reference Number" DataField="ReferenceNumber" ReadOnly="True" ItemStyle-Width="15%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                    </asp:BoundField>
                    
                       <asp:BoundField DataField="CC4Digit" HeaderText="CC No. (Last 4digit)" HtmlEncode="false" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Center" />
                      <asp:BoundField DataField="CCName" HeaderText="Name on CC" ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Center" />
