<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListOfComplimentary.aspx.cs" Inherits="SMS.ListOfComplimentary" %>
     ...
     <div class="container-fluid"  style="width:98%">
         ...
         <div class="row" style="margin-bottom: 5px;">
             <div class="col-sm-12">
                 ...
                 <div class="col-sm-3">
                     <asp:RadioButton ID="rbAll" runat="server" Text="" Checked="true" GroupName="grpIssRB" AutoPostBack="true" OnCheckedChanged="rbAll_CheckedChanged" />
                 </div>
             </div>
         </div>
          ...
          <div class="row" style="margin-bottom: 15px;">
                    <div class="col-sm-12">
                               <div class="col-sm-2 text-right">
                                ...
                                <div class="col-sm-9">
                                    <asp:RadioButton ID="rbPerItem" runat="server" Text="" GroupName="grpIssRB" AutoPostBack="true" OnCheckedChanged="rbPerItem_CheckedChanged"   />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:DropDownList ID="ddITemFG" runat="server" Enabled="false" class="chosen-select" Style="width: 695px;" oninvalid="this.setCustomValidity('Please select item')" oninput="setCustomValidity('')"  ></asp:DropDownList>
                                </div>
         ...
         <br />
                  <div class="row">
                    <div class="col-sm-12">
                        <asp:GridView ID="gvComplimentary" Width="99%" runat="server" AutoGenerateColumns="false" class="table table-striped table-bordered table-hover" >
                            <Columns>
                                   
                                 
                                        <asp:BoundField HeaderText="Complimentary No" DataField="Complimentaryno"  ReadOnly="True"  ItemStyle-Width="15%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                ...
                                <asp:BoundField HeaderText="Remarks" DataField="Remarks"  ReadOnly="True" ItemStyle-Width="10%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>

                                   <asp:BoundField HeaderText="Type" DataField="CompliType"  ReadOnly="True"  ItemStyle-Width="10px" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>

                                <asp:BoundField HeaderText="Encoded By" DataField="vUser_ID" HtmlEncode="false"  ReadOnly="True"  ItemStyle-Width="5%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>

                                    
                                    <asp:BoundField HeaderText="Date Encoded" DataField="TransactionDate" HtmlEncode="false" DataFormatString="{0:MM/dd/yyyy}"  ReadOnly="True"  ItemStyle-Width="10%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>

                                 <asp:BoundField HeaderText="Posted By" DataField="PostedBy"  ReadOnly="True" ItemStyle-Width="5%" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>

                                 <asp:BoundField HeaderText="Date/Time<br /> Posted(HO)" DataField="PostedDate" HtmlEncode="false"  ReadOnly="True" ItemStyle-Width="15%"  HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
