...
namespace SMS
{
    public partial class ReportGC : System.Web.UI.Page
    {
        ...
        private void genDP()
        {
            ...
            newFileName = Server.MapPath("~/exlDUMP/GCPayment.xlsx");
            ...
            if (fi.Exists)
            {
                ...
                worksheet.Cell("A1").Value = "GC Availment";
